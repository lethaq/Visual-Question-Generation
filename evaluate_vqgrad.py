...
from utils import NLGMetricverse
...
def get_w2v_embedding_old(name, embed_size, vocab):
    ...
    """
    name='/Users/ledrithaqi/Desktop/UZH/Master Thesis/VQG_RaD/Dataset/PubMed-w2v.bin'
...
def evaluate(vqg, data_loader, vocab, args, params):
    ...
    """
    vqg.eval()
    nlge = NLGMetricverse(metrics=["bleu", "meteor", "cider"])
    preds = []
    gts = []
    ...
    print ('='*80)
    scores = nlge(predictions = preds, references = gts)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--from-answer', type=str, default='false',
