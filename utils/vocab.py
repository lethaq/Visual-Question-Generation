...
if __name__ == '__main__':
    ...
    parser.add_argument('--questions', type=str,
                        default=dir + 'Dataset/train_questions_RAD_captions_titles_wiki_imagesAug_v1.json',#train_questions_RAD_captions_titles_wiki_imagesAug_v1.json
                        help='Path for train questions file.')
    parser.add_argument('--questions_val', type=str,
                        default=dir + 'Dataset/train_questions_RAD_captions_v_wiki_imagesAug_v2.json',#train_questions_RAD_captions_v_wiki_imagesAug_v2.json
                        help='Path for train questions file.')
    parser.add_argument('--questions_test', type=str,
                        default=dir + 'Dataset/train_questions_RAD_captions_v_wiki_imagesAug_v2.json',#train_questions_RAD_captions_v_wiki_imagesAug_v2.json
                        help='Path for train questions file.')
    parser.add_argument('--cat2ans', type=str,
                        default=dir + 'Dataset/cat2titles_RAD_wiki_v1.json',#data/vqa/cat2titles_RAD_wiki_v1.json
                        help='Path for the answer types.')
    parser.add_argument('--cat2caps', type=str,
                        default=dir + 'Dataset/cat2captions_RAD_wiki_v2.json',#data/vqa/cat2captions_RAD_wiki_v2.json
                        help='Path for the answer types.')
    # Hyperparameters.
