...
def save_dataset(image_dir, questions, annotations, vocab, ans2cat, caps2cat, output,
                 im_size=224, max_q_length=20, max_a_length=20, with_answers=False):
    ...
    # Drop the questions and annotations without images
    images = [f for f in os.listdir(image_dir) if f.endswith('.jpg')]
    annos = [a for a in annos if a['image_id'] in images]
    questions = [q for q in questions if q['image_id'] in images]
...
if __name__ == '__main__':
    ...
    # Inputs.
    parser.add_argument('--image-dir', type=str, default=dir + 'Dataset/VQA_RAD_Images',
                        help='directory for resized images')
    parser.add_argument('--questions', type=str,
                        default=dir + 'Dataset/train_questions_RAD_captions_titles_wiki_imagesAug_v1.json',
                        help='Path for train annotation file.')
    parser.add_argument('--annotations', type=str,
                        default=dir + 'Dataset/train_questions_RAD_captions_titles_wiki_imagesAug_v1.json',
                        help='Path for train annotation file.')
    parser.add_argument('--cat2ans', type=str,
                        default=dir + 'Dataset/cat2titles_RAD_wiki_v1.json',
                        help='Path for the answer types.')
    parser.add_argument('--cat2caps', type=str,
                        default=dir + 'Dataset/cat2captions_RAD_wiki_v2.json',
                        help='Path for the answer types.')
    parser.add_argument('--vocab-path', type=str,
                        default=dir + 'Dataset/vocab_vqgrad.json',
    ...
    parser.add_argument('--cat2name', type=str,
                        default=dir + 'Dataset/cat2name.json',
